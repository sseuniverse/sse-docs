...
export default defineNuxtModule<ModuleOptions>({
  ...
  async setup(options, nuxt) {
    ...
    addTemplate({
      ...
      getContents: () =>
        [
          "import type { ComponentData } from '#sse-nui/meta'",
    ...
    nuxt.options.alias["#sse-nui/meta"] = join(
      nuxt.options.buildDir,
      "component-meta.mjs"
    );
    nuxt.options.alias["#sse-nui/meta/types"] = join(
      nuxt.options.buildDir,
      "component-meta.d.ts"
    );
    ...
    nuxt.hook("nitro:config", (nitroConfig) => {
      ...
      nitroConfig.virtual["#sse-nui/meta/nitro"] = () =>
        readFileSync(
