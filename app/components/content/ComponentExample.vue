...
if (
  [
    "command-palette-theme-algolia",
    "command-palette-theme-raycast",
...
const hasCode = computed(
  () => !props.hiddenCode && (data?.code || instance.slots.code)
);
const hasPreview = computed(
  () => !props.hiddenPreview && (props.component || instance.slots.default)
);

const { data: ast } = await useAsyncData(
  `content-example-${camelName}-ast`,
  () =>
    transformContent(
